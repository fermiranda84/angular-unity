...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    var container: any = document.querySelector("#unity-container");
      ...
      var warningBanner: any = document.querySelector("#unity-warning");
      ...
      var loaderUrl = buildUrl + "/angular-nc-1.loader.js";
      var config = {
        dataUrl: buildUrl + "/angular-nc-1.data",
        frameworkUrl: buildUrl + "/angular-nc-1.framework.js",
        codeUrl: buildUrl + "/angular-nc-1.wasm",
